...
export default class KonkurskpkCtrl {
    ...
    startQuiz() {
        ...
        var text = '<p> Добрый день! Повторное участие в Викторине невозможно. Но у Вас все еще есть шанс выиграть главный приз – билеты на хоккей!  Более подробную информацию можно получить в личном кабинете.</p>';
